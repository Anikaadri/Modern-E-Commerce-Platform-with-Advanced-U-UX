...
try {
    ...
    $database->execute(
        "INSERT IGNORE INTO products (category_id, name, description, price, stock, image, is_featured) 
         VALUES (:cat, :name, :desc, :price, :stock, :image, :featured)",
        [
            ':cat' => 1,
            ':name' => 'Laptop Pro',
    ...
    echo "✓ Admin user created (admin@onlineshop.local / admin123)\n";

    echo "\n✅ Database initialization completed successfully!\n";
    echo "\n📋 Admin Credentials:\n";
    echo "   Email: admin@onlineshop.local\n";
    echo "   Password: admin123\n";
    echo "\n🌐 Access your store at:\n";
    echo "   http://localhost/online-shop/public/\n";
    echo "\n🔧 Admin dashboard at:\n";
    echo "   http://localhost/online-shop/public/admin.php\n";
    echo "</pre>";
